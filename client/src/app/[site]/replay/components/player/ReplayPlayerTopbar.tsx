...
export function ReplayPlayerTopbar() {
  ...
  if (!data?.metadata) {
    return (
      <div className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-2 py-2 rounded-t-lg overflow-hidden">
  ...
  return (
    <div className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-2 py-2 rounded-t-lg overflow-hidden">
      <div className="flex items-center justify-between min-w-0">
        ...
        <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400 flex-shrink-0 ml-2">
          <CountryFlagTooltipIcon
