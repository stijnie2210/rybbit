...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] rounded-lg border border-neutral-200 bg-neutral-50 p-1 text-neutral-950 shadow-2xl dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-50",
